...
const Deals = () => {
    return (
        <div className=''>
            <h2 className='text-[#2C384A] md:text-3xl text-4xl   leading-[44px] font-normal'>Related deals you might like for</h2>
            <div className='grid grid-cols-3 gap-3 mt-2'>
                {
                    data.map((obj, index) => {
                        return <div className='p-2 col-span-3 sm:col-span-1 bg-white flex flex-col gap-5' key={index}>
            ...
            <div className='flex flex-col md:flex-row items-center justify-between my-10'>
                <p className='  text-[#5C6874] md:text-3xl text-xl md:leading-[44px]'>Sign up and get exclusive <br /> special deals</p>
                <div className=''>
